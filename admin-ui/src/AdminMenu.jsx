        ...
        <div className="admin-container">
            <div className="admin-sidebar">
                ...
                <ul className="admin-nav">
                    <li className="active"><span className="admin-icon">🍽️</span> Menu Management</li>
                    <li><span className="admin-icon">📊</span> Dashboard</li>
                    <li><span className="admin-icon">🛒</span> Orders</li>
                    <li><span className="admin-icon">👥</span> Customers</li>
                    <li><span className="admin-icon">⚙️</span> Settings</li>
                </ul>
            </div>
                ...
                <div className="admin-card">
                    ...
                    <div className="admin-form">
                        ...
                        <div className="form-actions">
                            <button onClick={handleAddMenuItem} className="add-btn">Add Menu Item</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <div className="action-buttons">
                                                <button className="edit-btn" onClick={() => handleEditMenuItem(item.id)}>Edit</button>
                                                <button className="delete-btn" onClick={() => handleDeleteMenuItem(item.id)}>Delete</button>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
